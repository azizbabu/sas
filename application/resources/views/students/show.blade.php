...
<div id="panel-1" class="panel panel-default">
	...
	<div class="panel-footer">
		<a class="btn btn-default btn-sm" href="{{ URL::to('students/' . $student->id . '/edit') }}" title="Edit Employee"><i class="fa fa-pencil"></i> Edit</a>
		<a class="btn btn-info btn-sm" href="{{ URL::to('students/list') }}" title="Go Back"><i class="fa fa-backward"></i> Go Back</a>
	</div>
</div>
