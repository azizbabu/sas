...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            <label for="section" class="control-label">Section {!! validation_error($errors->first('section'),'section') !!}</label>
    ...
    <div class="col-sm-6">
        ...
        @if(empty($student))
        <div class="form-group">
            <label for="recaptcha" class="control-label">Recaptcha {!! validation_error($errors->first('g-recaptcha-response'),'g-recaptcha-response') !!}</label>
