...
@section('title') Report of Sectionwise Attendance @endsection 
	...
	<div class="col-md-12">
		<div class="panel panel-default margin-top-20">
			<div class="panel-heading">
				Report of Sectionwise Attendance
			</div>
			...
			<div class="panel-footer">
				<div class="btn-group margin-top-20">
		        	<a href="{{ url('reports/sectionwise-attendance/print').(count(request()->all()) ? '?class='.request()->class.'&section='.request()->section.'&date_range='.request()->date_range : '') }}" class="btn btn-primary" target="_blank"><i class="fa fa-print" aria-hdden="true"></i> Print</a>
		            <a href="{{ url('reports/sectionwise-attendance/pdf').(count(request()->all()) ? '?class='.request()->class.'&section='.request()->section.'&date_range='.request()->date_range : '') }}" class="btn btn-primary" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
		        </div>
			</div>
			@endif
